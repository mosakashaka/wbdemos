...
public class MyIKSegmenter {
     ...
     */
    public MyIKSegmenter(Reader input, boolean useSmart) {
        this.input = input;
     ...
     */
    public MyIKSegmenter(Reader input, Configuration cfg) {
        this.input = input;
        this.cfg = cfg;
        this.init();
    }
    ...
    private void init() {
        ...
        // 初始化分词上下文
        this.context = new MyAnalyzeContext(this.cfg);
        // 加载子分词器
    ...
    private List<ISegmenter> loadSegmenters() {
        ...
        // 处理字母的子分词器(修改支持特殊字符)
        segmenters.add(new CustomLetterSegmenter());
        // 处理中文数量词的子分词器
