...
import org.wltea.analyzer.lucene.MyIKAnalyzer;
...
//    private final BlogTitleMapper blogTitleMapper;
    ...
    public String createIndex2() {
        return createIndexInner(new MyIKAnalyzer());
    }

    @GetMapping("/createIndex")
    public String createIndex() {
        return createIndexInner(new IKAnalyzer());
    }

    private String createIndexInner(Analyzer analyzer) {
//        List<BlogTitle> list = blogTitleMapper.selectList(Wrappers.lambdaQuery(BlogTitle.class));
        List<BlogTitle> list = new ArrayList<>();
        list.add(new BlogTitle(1L, "内容", "说明"));
        list.add(new BlogTitle(2L, "abc@google.com", "说明"));
        list.add(new BlogTitle(3L, "复合-文本", "说明"));
        ...
        for (BlogTitle blogTitle : list) {
            ...
            document.add(new TextField("description", blogTitle.getDescription(), Field.Store.YES));
            docs.add(document);
        }
